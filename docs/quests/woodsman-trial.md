...
| 1 | materials | 5 `logs` + 5 `stone` or `campfire_kit` | After chop: 5 `stone`, 1 `tinderbox` + forge hint |
...
2. Chop one tree → journal stage 2 → talk → receive 5 stone and a tinderbox.
